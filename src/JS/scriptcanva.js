document.addEventListener('DOMContentLoaded', function (event) {
    ...
    for (i = 0; i < document.getElementsByClassName("swatch").length; i++) {
        document.getElementsByClassName("swatch")[i].style.backgroundColor = colors[i];
    }

    const colors = ["#FF8080", "#8080FF", "#FFD700"];
